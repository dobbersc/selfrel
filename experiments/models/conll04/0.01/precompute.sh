...
# for the optimal initial teacher model on 1% of the training data from the CoNLL04 corpus.
...
selfrel train conll04 \
  ...
  --base-path /glusterfs/dfs-gfs-dist/dobbersc-pub/cc-news/precomputed/conll04/0.01 \
