...
def annotate(
    ...
    # Load Flair classifier and infer label type and abstraction level
    ...
    with dataset_path.open("r", encoding="utf-8") as dataset_file:
        global_columns: str = dataset_file.readline().strip("\n")

    global_label_types: LabelTypes = LabelTypes.from_global_columns(global_columns)
